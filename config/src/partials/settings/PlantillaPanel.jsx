...
import PlantillaTabla from "../abm_plantilla/PlantillaTabla";
import EditorPlantilla from "../../components/EditorPlantilla";

function PlantillaPanel() {
      ...
      <div className="relative flex flex-col flex-1 overflow-y-auto overflow-x-hidden">
        <main className="grow">
          <div className="px-4 sm:px-6 lg:px-8 py-8 mx-auto">
            ...
            {/* Search and New User Button Row */}
            ...
            {/* Table */}
            <PlantillaTabla selectedItems={handleSelectedItems} />

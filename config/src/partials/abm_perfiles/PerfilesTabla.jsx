...
function PerfilesTabla({ selectedItems }) {
  const plazas = [
    { id: "0", nombre: "Perfil 1" },
    { id: "1", nombre: "Perfil 2" },
    { id: "2", nombre: "Perfil 3" },
    { id: "3", nombre: "Perfil 4" },
    { id: "4", nombre: "Perfil 5" },
  ];

...
function ResetearContraseña() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    const validacion = validarReset(data);
    setErrores(validacion); // Actualizamos los errores

    // Si no hay errores, podemos proceder con el envío
    if (Object.keys(validacion).length === 0) {
      console.log("Formulario enviado correctamente.");
      // Aquí puedes realizar la lógica para enviar la solicitud al backend
    }
  };
